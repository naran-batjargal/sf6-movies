...
final class Version20231020223822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ad (id INT AUTO_INCREMENT NOT NULL, content VARCHAR(255) NOT NULL, price VARCHAR(255) DEFAULT NULL, created_timestamp DATETIME NOT NULL, updated_timestamp DATETIME DEFAULT NULL, user_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
